...
Widget dropDownWallets(List<Wallet> items, Wallet selectedValue, String hint,
  ...
  return Container(
    ...
    child: DropdownButton<Wallet>(
      ...
      elevation: 10,
      dropdownColor: gIsDarkMode ? Get.theme.backgroundColor : Get.theme.dividerColor,
      ...
      children: [
        Row(
          ...
          children: [
            ...
            if (fromKey.isValid)
              Icon(fromKey == FromKey.up ? Icons.arrow_upward : Icons.arrow_downward, color: mainColor, size: Dimens.iconSizeExtraMin)
          ],
        ),
        ...
        children: [
          ...
          Expanded(
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Flexible(child: AutoSizeText(text, style: Get.textTheme.bodyMedium, maxLines: 2, textAlign: TextAlign.center)),
