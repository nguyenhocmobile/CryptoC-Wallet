...
class ActivityScreenState extends State<ActivityScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Obx(() => gUserRx.value.id == 0
        ? Column(children: [appBarMain(context, title: "Activity".tr), signInNeedView()])
        : Column(
            children: [
              appBarMain(context, title: "Activity".tr),
                ...
                children: List.generate(
                  ...
                  (index) {
                    if (key == HistoryType.swap) {
                      ...
                      return _buyOrderItemView(_controller.activityDataList[index], historyData, key);
  ...
  Widget _buyOrderItemView(Trade tradeHistory, List historyData, String type) {
