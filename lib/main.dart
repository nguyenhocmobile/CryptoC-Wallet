...
import 'package:tradexpro_flutter/ui/features/home/home_screen.dart';
...
Future<void> _setDefaultValues() async {
  ...
  GetStorage()
      .writeIfNull(PreferenceKey.languageKey, LanguageUtil.defaultLangKey);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (ctx) => Coins()),
        ],
