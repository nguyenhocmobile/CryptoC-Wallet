        ...
        return Column(
          ...
          children: [
            Row(
              children: [
                ...
                buttonOnlyIcon(
                    ...
                    iconColor: gIsDarkMode ? context.theme.primaryColor : context.theme.backgroundColor,
                    onPressCallback: () {
                      Get.back();
            ...
            Container(
                ...
                decoration: boxDecorationRoundCorner(color: Get.theme.backgroundColor),
                child: customView)
          ],
        );
      });
