...
void showToast(String text, {bool isError = true, bool isLong = false, BuildContext? context}) {
  if (context != null) {
    Widget toast = Container(
        ...
        child: textAutoSizePoppins(text, color: isError ? Colors.white : Theme.of(context).backgroundColor, maxLines: 10));
    ...
    Fluttertoast.showToast(
        ...
        textColor: isError ? Colors.white : Get.theme.backgroundColor);
  }
}
