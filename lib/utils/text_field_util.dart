...
Widget textFieldBordered(BuildContext context,
  ...
  return SizedBox(
      ...
      child: TextField(
        ...
        style: Get.theme.textTheme.headline5!.copyWith(fontSize: 15, fontWeight: FontWeight.bold),
        maxLines: 1,
        ...
        decoration: InputDecoration(
          ...
          hintText: hint,
          hintStyle: Get.theme.textTheme.subtitle1!.copyWith(fontWeight: FontWeight.normal),
