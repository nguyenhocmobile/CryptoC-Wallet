...
Widget showCircleAvatar(String? url, {double size = 90}) {
  return ClipOval(
    child: CachedNetworkImage(
      ...
      height: size,
      fit: BoxFit.cover,
      placeholder: (context, url) => SvgPicture.asset(AssetConstants.icLogo, color: Get.theme.primaryColor),
      errorWidget: (context, url, error) => SvgPicture.asset(AssetConstants.icLogo, color: Get.theme.primaryColor),
    ),
  );
}
